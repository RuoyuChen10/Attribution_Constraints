...
def main_worker():
    ...
    parser.add_argument("--output_dir", default="./ckpt_vision_saliency_bench/ckpts_vit_b16_imnet_XIL/")
    ...
    model = ViTForImageClassification.from_pretrained(
        ...
        num_labels=args.num_classes,            # 你的类别数
